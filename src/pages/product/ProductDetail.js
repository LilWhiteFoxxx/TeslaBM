        ...
        <>
            ...
            {/* <div className="flex flex-col">
                <div className="flex justify-center items-center">
                    <div className="w-[300px] h-[2px] bg-black"></div>
                    <SectionHeadlines className="w-[240px] h-[120px]" />
                    <div className="w-[300px] h-[2px] bg-black"></div>
                </div>
                <p className="text-xl font-bold mb-4">BORN ON THE RACETRACK</p>
                <div>
                    <div className="flex justify-center items-center">
                        <img src={dataAndEquipment.imgData} alt="data" />
                    </div>
                    <div className="flex items-center justify-center">
                        <div className="flex flex-col">
                            <div className="flex flex-col items-center">
                                <p>{dataAndEquipment.atbOne.atbNumber}</p>
                                <div className="w-[240px] h-[2px] bg-black"></div>
                                <p>{dataAndEquipment.atbOne.atbName}</p>
                            </div>
                            <div className="flex flex-col items-center">
                                <p>{dataAndEquipment.atbTwo.atbNumber}</p>
                                <div className="w-[240px] h-[2px] bg-black"></div>
                                <p>{dataAndEquipment.atbTwo.atbName}</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center">
                            ...
                            <p>
                                Water/oil-cooled four-cylinder four-stroke
                                in-line engine
                            </p>
                            <div className="flex items-center justify-center w-[220px] h-[30px] bg-black mt-4">
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-col items-center">
                                <p>{dataAndEquipment.atbThree.atbNumber}</p>
                                <div className="w-[240px] h-[2px] bg-black"></div>
                                <p>{dataAndEquipment.atbThree.atbName}</p>
                            </div>
                            <div className="flex flex-col items-center">
                                <p>{dataAndEquipment.atbFour.atbNumber}</p>
                                <div className="w-[240px] h-[2px] bg-black"></div>
                                <p>{dataAndEquipment.atbFour.atbName}</p>
                            </div>
                        </div>
                    </div>
                </div>
